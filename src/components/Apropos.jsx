...
const Apropos = () => {
  ...
  return (
    <>
      ...
      <div id="about" className="relative justify-center items-center overflow-hidden md:px-8 md:mx-auto  w-full  bg-gray-100 md:my-10 my-5  flex flex-col md:flex-row md:gap-5">
      <ContactPoppup openPoppup={openAboutPoppup} closePoppup={setOpenAboutPoppup}/>
        <div className=" md:rounded-none md:h-full mx-auto md:w-[50%]  h-full bg-[#7280FF] w-[70%] py-7 mt-14 rounded-md ">
          ...
          <ul className=" flex gap-6 justify-center my-6">
            ...
            <li className="text-white hover:scale-y-90 duration-300 cursor-pointer">
              <AiOutlineWhatsApp size={27} onClick={()=> setOpenAboutPoppup(true)} />
            </li>
            <li className="text-white hover:scale-y-90 duration-300 cursor-pointer">
